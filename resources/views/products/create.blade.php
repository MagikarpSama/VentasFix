...
<div class="container mt-5">
    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="precio_neto" name="precio_neto" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="stock_bajo" name="stock_bajo" required>
        </div>
        <div class="mb-3">
            <label for="stock_alto" class="form-label">Stock Alto</label>
            <input type="number" class="form-control" id="stock_alto" name="stock_alto" required>
        </div>
